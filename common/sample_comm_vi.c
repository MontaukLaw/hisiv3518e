...
HI_S32 SAMPLE_COMM_VI_StartDev(VI_DEV ViDev, SAMPLE_VI_MODE_E enViMode)
{
    ...
    if ((SAMPLE_VI_MODE_BT1120_1080P != enViMode) && (SAMPLE_VI_MODE_BT1120_720P != enViMode))
    {
...
HI_S32 SAMPLE_COMM_VI_StartChn(VI_CHN ViChn, RECT_S *pstCapRect, SIZE_S *pstTarSize, SAMPLE_VI_CONFIG_S *pstViConfig)
{
    ...
    if (pstViConfig)
    {
        ...
        SAMPLE_PRT("enRotate: %d enViChnSet: %d \n", enRotate, enViChnSet);
    }
...
HI_S32 SAMPLE_COMM_VI_StartMIPI_BT1120(SAMPLE_VI_MODE_E enViMode)
{
    ...
    if ((enViMode == SAMPLE_VI_MODE_BT1120_720P) || (enViMode == SAMPLE_VI_MODE_BT1120_1080P))
    {
...
HI_S32 SAMPLE_COMM_VI_SetMipiAttr(SAMPLE_VI_CONFIG_S *pstViConfig)
{
    ...
    if ((pstViConfig->enViMode == OMNIVISION_OV9752_MIPI_720P_30FPS) || (pstViConfig->enViMode == OMNIVISION_OV9750_MIPI_720P_30FPS))
    {
    ...
    if ((pstViConfig->enViMode == APTINA_9M034_DC_720P_30FPS) || (pstViConfig->enViMode == APTINA_AR0130_DC_720P_30FPS) || (pstViConfig->enViMode == SONY_IMX222_DC_1080P_30FPS) || (pstViConfig->enViMode == SONY_IMX222_DC_720P_30FPS) || (pstViConfig->enViMode == OMNIVISION_OV9712_DC_720P_30FPS) || (pstViConfig->enViMode == OMNIVISION_OV9732_DC_720P_30FPS))
    {
...
HI_S32 SAMPLE_COMM_VI_StartVi(SAMPLE_VI_CONFIG_S *pstViConfig)
{
    ...
    {
        SAMPLE_PRT("SAMPLE_COMM_VI_StartBT656\n");
        s32Ret = SAMPLE_COMM_VI_StartBT656(pstViConfig);
    }
    else
    {
        SAMPLE_PRT("SAMPLE_COMM_VI_StartIspAndVi\n");
...
void SAMPLE_COMM_VI_SaveFpnData(ISP_FPN_FRAME_INFO_S *pVBuf, HI_U32 u32FpnMode, HI_U32 u32Nbit, FILE *pfd)
{
    ...
    /* save Y ----------------------------------------------------------------*/
    fprintf(stderr, "saving......Raw data......u32Stride[0]: %d, width: %d, height: %d\n", pVBuf->stFpnFrame.stVFrame.u32Stride[0], pVBuf->stFpnFrame.stVFrame.u32Width, pVBuf->stFpnFrame.stVFrame.u32Height);
